...
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Strings             | `str_length`, `str_char_at`, `str_slice`, `str_slice_window`, `str_copy`, `str_concat`, `str_eq`, `str_from_char_code`, `str_index_of`, `str_includes`, `str_starts_with`, `str_trim`, `str_replace_all`, `char_code`, `int_to_string`, `parse_int` | `src/main/tuff/selfhost/runtime_lexer.tuff`, generated C | Implemented in `tuff_runtime.c`; `str_slice_window` is compatibility-first copy behavior pending lifetime-window ABI cutover. |
