...
const __bridgeFns = [
  ...
  "__vec_init", "__vec_capacity", "__vec_clear", "__vec_join", "__vec_includes", "__vec_clone",
  "__map_new", "mapSet", "mapGet", "mapGetOrDefault", "mapHas", "mapDelete", "mapClear", "__set_new", "setAdd",
  "setHas", "setDelete", "setClear", "readFile", "writeFile", "pathJoin", "pathDirname",
