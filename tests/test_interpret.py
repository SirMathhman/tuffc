...
def test_logical_or_true_false():
    assert interpret("true || false") == "true"


def test_logical_or_false_false():
...
def test_mutable_if_statement_changes_outer_variable():
...
def test_let_outside_then_block_returns_value():
    assert interpret("let x = 100; {x}") == "100"
